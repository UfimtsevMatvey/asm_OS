...
;4 Читать сектор по линейному адресу  /bx:es , dx - LBA, cx - количество секторов
;5 Записать файл. Вход: dx:si - адресс имя, cx - размер в секторах, bx:es - адресс начала , al - байт атрибутов
